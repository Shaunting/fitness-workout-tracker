...
# Observation
# Lots of outliers for all data


### Ploting outliers in time ###
...
### IQR function (Mark IQR outliers) ###
...
### Chauvenet's function (Mark Outliers) ###
...
# Observation
# Much lesser outliers for all accelorometer and gyroscopes
...
# Observation
# Chauvenet is best because the others are too strict in terms of outliers and would make use lose lots of data
...
dataset[dataset["acc_x_outlier"]]  # Boolean indexing - Selecting all outliers

# Replace values marked as outliers to NaN
...
for col in outlier_columns:
    for label in df["label"].unique():
        # Mark outliers using chauvenet function
